...
const Button: React.FC<ButtonProps> = (props) => {
  ...
  const base =
    "px-6 py-4 text-sm font-bold tracking-[0.2em] uppercase font-narrow inline-flex items-center justify-center transition-all duration-300 transform active:scale-95";
