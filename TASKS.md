...
- [ ] 10. **[Claude] Publish the banked pipeline at 3/week (Mon/Wed/Fri).**
  ...
  **Next slots:** Mon 08-03, suggested `reactive-leadership-is-a-margin-problem` (**zero inbound — add the inbound link at publish, not before**). Reasoning: 07-28/07-30/07-31 ran three straight chiefs + governance/finance pieces, and this one moves to Leaders of Leaders; it is also the only way the `second-seat` cover gets an outing in social production (#9a), per DISTRIBUTION_LOG § Notes. Wed 08-05 open. Optional: a temporary 4th day/week for ~2 weeks to seed pieces around the Jul 30–Aug 5 cohort. Bank lasts ~6.5 weeks; refill comes from cohort exhaust (#14) and Search Console (#12), never invented topics.
